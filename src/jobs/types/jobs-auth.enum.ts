export enum CreateJobAuth {
  ...
  // User's email, or one of their groups, appears in
  // jobPolicies.<jobType>.allowedList on the Policy for the ownerGroup of
  // every dataset in `datasetIds`.
  DatasetPolicyList = "#datasetPolicyList",
